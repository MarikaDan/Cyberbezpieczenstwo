...
namespace CyberBezp.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(UserManager<IdentityUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<IdentityOptions> identityOptions, ISystemLogger systemLogger)
        {
        ...
        {
            var logs = _systemLogger.GetLogs();
